(function () {
  ...
  const generalEvents = [
    { title:{cs:"Noc vědy 2026: Komunikace",en:"Science Night 2026: Communication"}, date:{cs:"25. 9. 2026",en:"25 Sep 2026"}, text:{cs:"ggLab, SAGElab a UXLab: komunikace ve hře, prostřednictvím obrazu i uživatelského rozhraní.",en:"ggLab, SAGElab and UXLab: communication through games, shared images and user interfaces."}, img:"/assets/events/noc-vedy-2026/sagelab.webp", href:{cs:"noc-vedy-2026/",en:"../noc-vedy-2026/en/"} },
    { title:{cs:"Návštěva studentů z University of Kanazawa",en:"Visit by students from Kanazawa University"}, date:{cs:"Datum bude doplněno",en:"Date to be added"}, text:{cs:"SAGELab, ggLab, dotyková stěna a studentské hry — včetně Útěku z Brna.",en:"SAGELab, ggLab, the touch wall and student games — including Escape from Brno."}, img:"/assets/events/kanazawa/kanazawa-students.webp", href:{cs:"kanazawa/",en:"../kanazawa/en/"} },
